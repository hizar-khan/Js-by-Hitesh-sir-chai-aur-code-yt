...
/*
   ...
   line-1--> val1 = undifined 
    ...
    all lines of funcion(function body will went in definition)
    so the contronl will shift outside the body of function
    now at next line , we have , 
    result1 = undifined 
    result2 = undifined 
    ...
    we will start again from line 1
     ...
     we already hold its definition
     ...
     total is also returning to addNum(it is returning to the parent which global exection context)
      the new execution context which was created at the time of function exection will delete after the values return to the GEC
      now the values will store at variable  result1
       ...
       in memeory phase
    the above processe will happen again
