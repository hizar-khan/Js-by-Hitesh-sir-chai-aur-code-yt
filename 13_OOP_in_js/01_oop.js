...
const user ={
    ...
    console.log(this); // here we are using this inside an object --> user and we know that "this" have current context in which it is 
...
// but if we c.log(this) inside the browser or other eniment than it value will be change, it will contain global context of that enviromnt
// inside the browser 'this' will have 'window' obj in it ,which global obj in it contains many things


// now if i want to add data of diffent users inside DB than make object of each user will be lenght for this will use constructor
...
function user(userName, loginCount, isLoggedIn){
    ...
    // but someTime these same varible and value-name make confussion or someTime we can make them differnt e.g varible:myUserName and vale: username
...
// return this // no need of return bcz it is used as bydefault ,,it is define Implictlly // now this "this" will contain userName loginCoun and isLoggIn values as an obj {}
}
const userOne = new user('hizar khan', 8, true)
console.log(userOne);
const userTwo = new user('Ali ', 4, false)
console.log(userTwo);
// this mean that the above ftn which called construtor ftn is like a frame and we can make more than one objects with different values
